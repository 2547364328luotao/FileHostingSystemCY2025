    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      %>
        ...
        <head>
          ...
          <title>AlistFHS图床</title>

          <!-- 引入Google字体 - Nunito和Roboto字体系列 -->
          <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700,800|Roboto:400,500,700"
            rel="stylesheet">

          <!-- 引入动画库 -->
          <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/vendor/animate/animate.min.css"
            type="text/css">
        ...
        <body>
          ...
          <nav class="navbar navbar-expand-lg navbar-dark navbar-transparent py-4">
            <div class="container">
              ...
              <div class="navbar-collapse offcanvas-collapse mr-auto" id="navbar_main">
                <ul class="navbar-nav ml-auto align-items-lg-center">
                  ...
                  <li class="nav-item ml-lg-4">
                    <% if (user !=null) { %>
                      <!-- 已登录：显示A组件 -->
                      <a href="${pageContext.request.contextPath}/userCen.jsp"
                        class="btn btn-sm bg-white btn-icon mr-2 text-success">
                        <span class="btn-inner--icon"><i class="fa-solid fa-circle-user"></i></span>
                        <span class="btn-inner--text">用户中心</span>
                      </a>
                      <% } else { %>
                        <!-- 未登录：显示B组件 -->
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link nav-link-icon nav-icon-red"><svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link nav-link-icon nav-icon-cyan"><svg xmlns="http://www.w3.org/2000/svg"
                        width="20" height="20" viewBox="0 0 24 24">
                        <g fill="none">
                          <path
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link nav-link-icon nav-icon-blue"><svg xmlns="http://www.w3.org/2000/svg"
                        width="20" height="20" viewBox="0 0 24 24">
                  ...
                  <li class="nav-item">
                    <a href="https://github.com/2547364328luotao/FileHostingSystemCY"
                      class="nav-link nav-link-icon nav-icon-green"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                        height="20" viewBox="0 0 24 24">
                        <mask id="IconifyId1971632191cd242eb3" width="24" height="24" x="0" y="0">
                          <g fill="#fff">
                        ...
                        <rect width="8" height="4" x="8" y="11" fill="currentColor"
                          mask="url(#IconifyId1971632191cd242eb3)">
                  ...
                  <div class="row cols-xs-space align-items-center text-center text-md-left justify-content-center">
                    <div class="col-7">
                      <div class="text-center mt-5">
                        <img src="${pageContext.request.contextPath}/assets/images/brand/icon.png" style="width: 250px;"
                        ...
                        <p class="lead text-white mt-3 lh-180 c-white description-text">
                          Let everyone enjoy the high-speed of the times without bandwidth anxiety<strong
                            class="text-white">CloudFlare</strong>
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <script src="${pageContext.request.contextPath}/assets/vendor/fontawesome/js/fontawesome-all.min.js"
            defer></script>
